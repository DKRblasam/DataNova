                    ...
                    <?php foreach ($restaurantesData as $restaurante): ?>
                        <div class="bg-white shadow-lg rounded-lg overflow-hidden transform hover:scale-105 transition duration-300">
                            ...
                            <div class="p-4">
                                ...
                                <a href="./reservaciones.php" class="text-blue-600 mt-4 block text-center py-2 px-4 rounded-lg border-2 border-blue-600 hover:bg-blue-600 hover:text-white transition duration-300">Reservar</a>
                            </div>
                        </div>
                    <?php endforeach; ?>
                <?php else: ?>
